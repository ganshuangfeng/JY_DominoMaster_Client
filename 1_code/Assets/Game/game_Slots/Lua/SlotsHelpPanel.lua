...
SlotsHelpPanel = basefunc.class()
local M = SlotsHelpPanel
M.name = "SlotsHelpPanel"
...
function M:RemoveListenerGameObject()
    ...
    self.last_btn.onClick:RemoveAllListeners()
...
function M:InitPageNumList()
	...
	for i = 1, self.pageAmount do
		...
		pageNum.obj = newObject("SlotsHelpPageNum", self.pagenums)
